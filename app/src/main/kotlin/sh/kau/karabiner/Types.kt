...
data class Manipulator(
  ...
  val from: From,
  val to: List<To>? = null,
  @SerialName("to_if_alone")
  val toIfAlone: List<To>? = null,
  @SerialName("to_after_key_up")
  val toAfterKeyUp: List<To>? = null,
...
data class From(
  ...
  @SerialName("simultaneous_options")
  val simultaneousOptions: SimultaneousOptions? = null,
  val modifiers: Modifiers? = null
)

@Serializable
data class SimultaneousFrom(
  @SerialName("key_code")
  val keyCode: KeyCode
)
...
data class SimultaneousOptions(
  ...
  @SerialName("key_up_when")
  val keyUpWhen: String? = null, // Consider enum: "any", "all"
  @SerialName("to_after_key_up")
  val toAfterKeyUp: List<To>? = null
)
...
data class To(
  ...
  val setVariable: SetVariable? = null,
  @SerialName("mouse_key")
  val mouseKey: MouseKey? = null,
  @SerialName("pointing_button")
  val pointingButton: String? = null,
  @SerialName("software_function")
  val softwareFunction: SoftwareFunction? = null
...
data class MouseKey(
  ...
  @SerialName("vertical_wheel")
  val verticalWheel: Int? = null,
  @SerialName("horizontal_wheel")
  val horizontalWheel: Int? = null
)
...
enum class KeyCode {
  ...
  KEYPAD_ENTER,
  @SerialName("keypad_1")
  KEYPAD_1, @SerialName("keypad_2")
  KEYPAD_2, @SerialName("keypad_3")
  KEYPAD_3,
  @SerialName("keypad_4")
  KEYPAD_4, @SerialName("keypad_5")
  KEYPAD_5, @SerialName("keypad_6")
  KEYPAD_6,
  @SerialName("keypad_7")
  KEYPAD_7, @SerialName("keypad_8")
  KEYPAD_8, @SerialName("keypad_9")
  KEYPAD_9,
  @SerialName("keypad_0")
  KEYPAD_0,
  ...
  @SerialName("vk_none")
  VK_NONE,
  @SerialName("print_screen")
  PRINT_SCREEN,
  @SerialName("scroll_lock")
  SCROLL_LOCK,
  @SerialName("pause")
  PAUSE,
  @SerialName("insert")
  ...
  @SerialName("find")
  FIND,
  @SerialName("international1")
  INTERNATIONAL1,
  @SerialName("international2")
  INTERNATIONAL2,
  @SerialName("international3")
  INTERNATIONAL3,
  @SerialName("international4")
  INTERNATIONAL4,
  @SerialName("international5")
  INTERNATIONAL5,
  @SerialName("international6")
  INTERNATIONAL6,
  @SerialName("international7")
  INTERNATIONAL7,
  @SerialName("international8")
  INTERNATIONAL8,
  @SerialName("international9")
  INTERNATIONAL9,
  @SerialName("lang1")
  LANG1, @SerialName("lang2")
  LANG2, @SerialName("lang3")
  LANG3,
  @SerialName("lang4")
  LANG4, @SerialName("lang5")
  LANG5, @SerialName("lang6")
  LANG6,
  @SerialName("lang7")
  LANG7, @SerialName("lang8")
  LANG8, @SerialName("lang9")
  LANG9,
  @SerialName("japanese_eisuu")
  JAPANESE_EISUU,
  @SerialName("japanese_kana")
  JAPANESE_KANA,
  @SerialName("japanese_pc_nfer")
  JAPANESE_PC_NFER,
  @SerialName("japanese_pc_xfer")
  JAPANESE_PC_XFER,
  @SerialName("japanese_pc_katakana")
...
data class FrontmostApplicationIfCondition(
  @SerialName("bundle_identifiers")
  val bundleIdentifiers: List<String>? = null,
...
data class Identifiers(
  ...
  @SerialName("is_keyboard")
  val isKeyboard: Boolean? = null,
  @SerialName("is_pointing_device")
  val isPointingDevice: Boolean? = null,
  @SerialName("is_touch_bar")
  val isTouchBar: Boolean? = null,
  @SerialName("is_built_in_keyboard")
  val isBuiltInKeyboard: Boolean? = null
)
...
data class KeyboardTypeIfCondition(
  @SerialName("keyboard_types")
  val keyboardTypes: List<String>,
  override val description: String? = null
) : Condition
...
data class InputSourceSpec(
  ...
  @SerialName("input_source_id")
  val inputSourceId: String? = null,
  @SerialName("input_mode_id")
  val inputModeId: String? = null
)

@Serializable
@SerialName("input_source_if")
data class InputSourceIfCondition(
  @SerialName("input_sources")
  val inputSources: List<InputSourceSpec>,
  override val description: String? = null
) : Condition
...
object DEVICE_COMBO {
  val APPLE_ALL = listOf(
    DEVICE.APPLE,
    DEVICE.KEYCHRON,
    DEVICE.APPLE_BUILT_IN
  )

  val ALL_KEYBOARDS = listOf(
    DEVICE.APPLE,
    DEVICE.KEYCHRON,
    DEVICE.APPLE_BUILT_IN,
    DEVICE.ANNE_PRO2,
...
data class GlobalSettings(
    @SerialName("check_for_updates_on_startup")
    val checkForUpdatesOnStartup: Boolean? = null,
    @SerialName("show_in_menu_bar")
    val showInMenuBar: Boolean? = null,
    @SerialName("show_profile_name_in_menu_bar")
    val showProfileNameInMenuBar: Boolean? = null,
    @SerialName("unsafe_ui")
    val unsafeUi: Boolean? = null
