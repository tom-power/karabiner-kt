...
@Serializable
data class FromFnKey(@SerialName("key_code") val keyCode: KeyCode)
...
@Serializable
data class SimpleModificationKey(@SerialName("key_code") val keyCode: KeyCode)

@Serializable
data class SimpleModificationValue(@SerialName("key_code") val keyCode: KeyCode)
